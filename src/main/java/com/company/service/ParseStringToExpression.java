...
public class ParseStringToExpression {
    ...
    public  List<String> ExpressionToReservePolishNotation(String expression) throws NotCorrectExpression, NotValidCharacterException {
        String expr = preparingExpression(expression);
        Validation.characterСheck(expr);
    ...
    protected String preparingExpression(String expr){
    ...
    protected int getPriority(char charachter)  {
